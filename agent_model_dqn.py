...
LR = 5e-4 # taxa de aprendizado do modelo
UPDATE_EVERY = 4 # atualização de frequência do modelo
GAMMA = 0.99 # factor de desconto
TAU = 1e-3 # para atualização suave dos parâmetros de destino
BATCH_SIZE = 64 # tamanho do minibatch

# Checking if there is gpu or not inside the machine that is running
...
class Agent():
    ...
    def get_action(self, state, eps=0.):
        '''
        Returns the actions of a given state, according to the current and established policy
    ...
    def learn(self, experiences, gamma):
        '''
        Updates the value parameters and using a given block of tuples
...
class QNetwork(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed):
        '''        
        Building the models and updating the data
